    ...
    <>
      ...
      <header className={styles.navbar}>
        ...
        <section className={styles.p2}>
          ...
          <img className={styles.colorImage} src="/placeholder.jpeg" alt="Color1" />
          <img className={styles.colorImage} src="/placeholder.jpeg" alt="Color2" />
          <img className={styles.colorImage} src="/placeholder.jpeg" alt="Color3" />
          <img className={styles.colorImage} src="/placeholder.jpeg" alt="Color4" />
          </div>
