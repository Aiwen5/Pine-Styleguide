...
<main className={styles.main}>
  ...
  <section className={styles.p3} id='p3'>
    ...
    <div className={styles.Rationale}>
      ...
      <p>For our web application, we carefully selected fonts that align with our branding and enhance the overall design theme. We chose the Poppins & ______ font families for their modern and clean appearance, which complements the aesthetic of our application. Here's why we opted for these particular fonts:</p>
